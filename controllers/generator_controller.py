...
class GeneratorController:
    ...
    def _connect_all(self):
        ...
        ui.btn_start.clicked.connect(self.toggle_generation)   # Start / Stop

        ui.btn_retry_errors.clicked.connect(self.retry_errors)
        ui.btn_retry_all.clicked.connect(self.retry_all)
        ui.btn_retry_one.clicked.connect(self.retry_selected)
    ...
    def _on_batch_done(self):
        """Gọi khi batch_runner.run_batch() kết thúc."""
        self._is_running = False
        self._cancel_event.clear()
